    ...
    !function (e, t) {
        ...
        !function (e) {
            var t, i = e.document, s = {
                ...
                if ("undefined" == typeof $ && n("simTreeneed jquery"),
                    $.isPlainObject(t)) {
                    if (t.el || n("你没有传el"),
                        !(this instanceof e))
                        return new e(t);
            ...
            r.prototype = {
                ...
                on: function (e, t, i) {
                    ...
                    return this.handles[e] = this.handles[e] || [],
                        ...
                        $.isFunction(t) && (!0 === i ? this.handles[e] = [t] : this.handles[e].push(t),
                            s && t.call(this, n)),
                        this
                },
                off: function (e) {
                ...
                trigger: function (e, t) {
                    var i, s;
                    for (this.handles[e] = this.handles[e] || [],
                        i = 0,
                        s = this.handles[e].length,
                        this.handles[e].isTriggered = !0,
                        this.handles[e].args = t; i < s; i++)
                ...
                render: function (e) {
                    ...
                    $.isFunction(e) && e({}, this.dataCallback.bind(this)),
                        $.isArray(e) && (e = this.parse(e),
                            this.doRender(this.$el, e))
                },
                doRender: function (e, t, s) {
                    ...
                    for (f.check || (C = C.replace('<i class="sim-tree-checkbox"></i>', "")); g < m; g++)
                        n = t[g],
                            ...
                            n[p.open] && o.push(n[v]);
                    m && e.append(y),
                        b ? (y.addClass("sim-tree"),
                            this.trigger("done", t),
                            $.each(o, function (e, t) {
                                u.expandNode(t)
                            }),
                            this.setSelected(d)) : f.childNodeAsy && (this.hideLoading(e.find(".sim-tree-spread")),
                                y.addClass("show"))
                },
                event: function () {
                    var e = this;
                ...
                doSpread: function (e, t) {
                    var i = e.parent()
                        , s = i.children("ul")
                        , n = i.data("data");
                    n.children && (t ? (e.removeClass("sim-icon-r").addClass("sim-icon-d"),
                        "asy" === e.data("type") && $.isFunction(this.data) && (this.showLoading(e),
                            this.data(i.data("data"), this.dataCallback.bind(this, i)),
                            e.data("type", "")),
                        s.addClass("show")) : (e.removeClass("sim-icon-d").addClass("sim-icon-r"),
                            s.removeClass("show")))
                },
                clickNode: function (e) {
                    var i, s, n, a = this, r = e.parent(), d = this.$el.find("li"), o = d.length, h = 0, c = [], l = !1;
                    if (!r.hasClass("disabled")) {
                        if (this.options.check)
                            for (l = !0,
                                this.doCheck(e.find(".sim-tree-checkbox")),
                                this.options.linkParent && (s = r.children("ul"),
                ...
                setParentCheck: function (e) {
                    var t, i = e.parent("ul"), s = i.parent("li"), n = i.children("li"), a = s.find(">a .sim-tree-checkbox"), r = [], d = n.length;
                ...
                search: function (e) {
                    if (this.$el) {
                        var t, i, s, e = $.trim(e), n = this.$el.find("li"), a = 0, r = n.length, d = [], o = new RegExp(e, "i");
                        for (n.hide().children(".sim-tree-spread").addClass("hidden"); a < r; a++)
                            i = n.eq(a),
                                t = i.children("a").text(),
                                s = i.data("data"),
                                e ? -1 !== t.search(o) && (1 !== parseInt(i.data("level")) && this.expandNode(s[this.options.response.pid]),
                                    i.parents("li").add(i).show(),
                                    d.push(i)) : (i.show(),
                                        s.children && i.children(".sim-tree-spread").removeClass("hidden"));
                ...
                expandNode: function (e) {
                    ...
                    i.children && n.length && (n.removeClass("hidden"),
                        this.doSpread(n, !0)),
                ...
                setSelected: function (e) {
                    ...
                    "string" != typeof i && "number" != typeof i || (i = [i]),
                        $.isArray(i) && (this.options.check || (i = [i[0]]),
                            $.each(i, function (e, i) {
