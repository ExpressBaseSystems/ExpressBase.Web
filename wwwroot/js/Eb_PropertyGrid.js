...
var Eb_PropertyGrid = function (id) {
    ...
    this.addToDD = function (obj) {
        ...
        if ($(".pgCXEditor-Cont").find("select").length > 0) {// need close look
