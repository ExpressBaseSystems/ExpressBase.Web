(function ($) {
    $.fn.ebFileViewer = function (options) {
        ...
        this.printImagefn=function() {

           // $("#printdiv").html(`<iframe id="iframePrint" src="${this.pgSettings[0].file_src}" ></iframe>`);
           // $("#iframePrint").get(0).contentWindow.print();
            var win = window.open('');
            win.document.write(`<img src=${this.pgSettings[0].file_src} onload="window.print();window.close()" />`);
            win.focus();
        }
