    ...
    public class EbBaseNewController : Controller
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            try
            {
               ...
               if(path.ToString().StartsWith("/Ext/", true, null) && !path.ToString().StartsWith("/Ext/Index", true, null) && !path.ToString().StartsWith("/Ext/StripeResponse", true, null) && !path.ToString().StartsWith("/Ext/Charge", true, null) && !path.ToString().StartsWith("/Ext/test", true, null) && !(context.Controller is ExpressBase.Web.Controllers.CommonController))
                {        
