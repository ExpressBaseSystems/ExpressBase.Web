var MultiLingualKeyEditor = function (settings) {
    ...
    this.loader = $("#loader" + this.ContID);
    this.loader2 = $("#loader2" + this.ContID);
    this.txtsearch = $("#txtsearch" + this.ContID);
    this.txtaddkey = $("#txtaddkey" + this.ContID);
    this.lstkeysuggestion = $("#lstkeysuggestion" + this.ContID);
    this.lstlangkeyval = $("#lstlangkeyval" + this.ContID);
    this.lblsearchkeyresult = $("#lblsearchkeyresult" + this.ContID);
    this.lblsearchkeyresult2 = $("#lblsearchkeyresult2" + this.ContID);
    this.lblloadkeyresult = $("#lblloadkeyresult" + this.ContID);
    this.divtable = $("#divtable" + this.ContID);
    this.searchtext = "";
    this.addnewkeylink = $("#addnewkeylink" + this.ContID);
    this.updatekeylink = $("#updatekeylink" + this.ContID);
    this.btnselect = $("#btnselect" + this.ContID);
    this.btnadd = $("#btnadd" + this.ContID);
    this.btnupdate = $("#btnupdate" + this.ContID);
    this.btnaddgo = $("#btnaddgo" + this.ContID);
    this.ulLiPagination = $(("#ulMLPagination" + this.ContID + " li"));
    this.txtPageNumber = $("#txtMLPageNumber" + this.ContID);
    this.Offset = 0;
    this.resultCount = 0;
    this.currentPage = 1;
    this.dataWindow;
    ...
    this.init = function () {
        this.AppendModal();
        $('#MLSettingsModal' + this.ContID).on('shown.bs.modal', this.initmodal.bind(this));
    ...
    <div class="modal-dialog" style="width:1000px">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:455px">
                <ul id="ultabs${this.ContID}" class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#menusearch${this.ContID}">Search</a></li>
                    <li><a data-toggle="tab" href="#menuadd${this.ContID}">Add/Update</a></li>
                </ul>
                <div class="tab-content">
                    <div id="menusearch${this.ContID}" class="tab-pane fade in active">
                        <div class="row" style="margin-top:20px">
                            <div class="col-md-5" style="">
                                <div class="input-group ">
                                    <input id="txtsearch${this.ContID}" title="Type to Search" type="text" data-value="" data-id="" data-object="" class="form-control" placeholder="Search">
                                    <span class="input-group-btn">
                                        <button id="btnsearch${this.ContID}" title="Click to Search" class="btn btn-secondary" type="button"><i class="fa fa-search" aria-hidden="true"></i></button>
                                    </span>
                                </div>
                                <div id="divPageNumberDisplay${this.ContID}" style="margin-top:15px">
                                    <i>Key Suggestions</i>
                                </div>
                                <div id="lstkeysuggestion${this.ContID}" class="list-group" style=" height:220px; overflow-y:auto; border:1px solid #ccc; margin-top:3px; margin-bottom:0px;">
                                ...
                                <div id="divMLPagination${this.ContID}" style="margin-top:5px; float: right;">
                                    <ul id="ulMLPagination${this.ContID}" class="pagination" style="margin:0px;">
                                        <li><a href="#" title="First">First</a></li>
                                        <li><a href="#" title="Previous">Prev</a></li>
                                        <li><a href="#" style="padding:0px;"> <input id="txtMLPageNumber${this.ContID}" type="text" class="form-control" title="Type Page Number and Press Enter" style="width:60px;height: 28px; border: none; margin: 2px; display:inline; text-align:center;"></a> </li>
                                        <li><a href="#" title="Next">Next</a></li>
                                        <li><a href="#" title="Last">Last</a></li>
                                    </ul>
                                </div>
                                <div id="lblsearchkeyresult${this.ContID}" style="padding:15px; display:none; margin-top:50px;">
                                    <b>Key Not Found! &nbsp;&nbsp; <a href="#" id="addnewkeylink"> Click Here</a>&nbsp;&nbsp; to add as new Key.</b>
                                </div>
                                <div id="lblsearchkeyresult2${this.ContID}" style="padding:15px; display:none ; margin-top:50px;">
                                    <b><a href="#" id="updatekeylink${this.ContID}"> Click Here</a> &nbsp;&nbsp;to Update Key.</b>
                                </div>
                            </div>
                            <div class="col-md-7" style="">
                                <div style="padding-top:10px;padding-bottom:10px;"><b>Language &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Meaning</b></div>
                                <div id="lstlangkeyval${this.ContID}" class="list-group" style="height:280px; overflow-y:auto;border:1px solid #ccc">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="menuadd${this.ContID}" class="tab-pane fade">
                            <div class="input-group" style="margin-top:20px">
                                <input id="txtaddkey${this.ContID}" type="text" data-value="" data-id="" class="form-control" placeholder="Enter a Key">
                                <span class="input-group-btn">
                                    <button id="btnaddgo${this.ContID}" title="Click to Load stored Key Values" class="btn btn-secondary" type="button"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                                </span>
                            </div>
                            <div id="lblloadkeyresult${this.ContID}" align="right" style=" display:none; padding-right:10%;">
                                <i >Key Not Found!</i>
                            </div>
                            <div id="loader2${this.ContID}" style="margin-left:45%; margin-top:10%"> <i class="fa fa-spinner fa-pulse fa-4x" aria-hidden="true"></i></div>
                            <div id="divtable${this.ContID}"  style="margin-top:10px; height:280px; overflow:auto">                                                              
            ...
            <div class="modal-footer" style="">
                <button id="btnadd${this.ContID}" type="button" class="btn btn-default" style="">Add</button>
                <button id="btnupdate${this.ContID}" type="button" class="btn btn-default" style="">Update</button>
                <button id="btnselect${this.ContID}" type="button" class="btn btn-default" style="">Select</button>
