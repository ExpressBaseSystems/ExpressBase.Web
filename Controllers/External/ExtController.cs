...
namespace ExpressBase.Web.Controllers
{
    ...
    public class ExtController : EbBaseExtController
    {
        ...
        public IActionResult ForgotPassword(int i)
        {
            ...
            if (!result.isUniq)
            {
                this.ServiceClient.Post(new EmailServicesMqRequest() { Refid = "expressbase-expressbase-15-26-26", SolnId = CoreConstants.EXPRESSBASE, newuserid = 0, To = Email, UserId = 0 });
