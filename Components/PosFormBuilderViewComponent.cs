...
{
    public class PosFormBuilderViewComponent : ViewComponent
    {
        protected JsonServiceClient ServiceClient { get; set; }

        protected RedisClient Redis { get; set; }

        public PosFormBuilderViewComponent(IServiceClient _client, IRedisClient _redis)
        {
