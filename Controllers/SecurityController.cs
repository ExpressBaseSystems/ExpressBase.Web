...
namespace ExpressBase.Web.Controllers
{
    public class SecurityController : EbBaseIntCommonController
    {
        ...
        public string GetUsersList(string searchtxt)
        {
            GetUserDetailsResponse temp = this.ServiceClient.Get<GetUserDetailsResponse>(new GetUserDetailsRequest { SearchText = searchtxt });
            return JsonConvert.SerializeObject(temp.UserList);
        }
