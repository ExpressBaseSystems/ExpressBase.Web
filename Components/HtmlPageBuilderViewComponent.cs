...
{
    public class HtmlPageBuilderViewComponent : ViewComponent
    {
        protected JsonServiceClient ServiceClient { get; set; }

        protected RedisClient Redis { get; set; }

        public HtmlPageBuilderViewComponent(IServiceClient _client, IRedisClient _redis)
        {
