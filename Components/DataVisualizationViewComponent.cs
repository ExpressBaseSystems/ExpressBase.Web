        ...
        private EbDataVisualization getDVObject(EbDataVisualization dvobj)
        {
            ...
            foreach (EbDataColumn column in __columns)
            {
                ...
                if (column.Type == EbDbTypes.String && column.ColumnName == "socialid")
                    ...
                    _col = new DVDateTimeColumn { Data = column.ColumnIndex, Name = column.ColumnName, sTitle = column.ColumnName, type="date-uk", Type = column.Type, bVisible = true, sWidth = "100px", Pos = _pos, ClassName = "tdheight" };
