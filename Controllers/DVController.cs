...
namespace ExpressBase.Web.Controllers
{
    public class DVController : EbBaseIntCommonController
    {
        ...
        public IActionResult dvCommon(string dvobj, string dvRefId, bool _flag, string contextId, bool customcolumn)
        {
            ...
            return ViewComponent("DataVisualization", new { dvobjt = dvobj, dvRefId = dvRefId, flag = _flag, _user = this.LoggedInUser, _sol = solu, contextId = contextId, CustomColumn = customcolumn });
        }
