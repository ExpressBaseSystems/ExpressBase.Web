(function () {
    $("body").append($('<iframe id="ebbot_iframe" width="25%" height="70%" class="eb-chat-frame" style="position: fixed;bottom: 65px!important; right: 24px!important; border-radius: 3.5px; box-shadow: 0 12px 40px 0 rgba(0,0,0,.175)!important; min-width: 300px; z-index: 99999999999999!important; display:none;" frameborder="0" allowfullscreen></iframe>')[0]);
    ...
    $("#chatbtn").on("click", function () {
        ...
        if (!ebbot_iframe.getAttribute("src")) {
            ebbot_iframe.setAttribute("src", "//eb_roby_dev.localhost:5000/bot/bot?tid=" + window.EXPRESSbase_SOLUTION_ID);
